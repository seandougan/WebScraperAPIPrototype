...
{
    public class VitaminsMass
    {
        [Key]
        public long VitaminsMassId { get; set; }
        ...
        public virtual ICollection<Nutrition> Nutritions { get; set; }  // Navigation Property for reverse mapping
    }
}